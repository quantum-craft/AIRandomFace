Shader "UEngine/UE Blend Blusher"
{
    Properties
    {
	...
	SubShader
	{
		...
		Pass
		{
            ...
            fixed4 frag (v2f i) : COLOR
            {
                ...
                half3 blusherTex = tex2D(_TattooTex, filter_uv(i.targetUV, _UVRegion)).rgb;
                //half3 blusherTex = tex2D(_TattooTex, i.uv).rgb;
                ...
                return float4(faceColor.rgb,faceColor.a);
            }
            ENDCG
		}
	}
